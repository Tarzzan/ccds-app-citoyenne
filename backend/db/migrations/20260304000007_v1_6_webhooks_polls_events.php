...
class V16WebhooksPollsEvents extends AbstractMigration
{
    public function change(): void
    {
        ...
        $polls
            ...
            ->addColumn('type',        'string',   ['limit' => 20, 'default' => 'single']) // single, multiple, rating
            ->addColumn('status',      'string',   ['limit' => 20, 'default' => 'active']) // active, closed
        ...
        $mentions
            ...
            ->addColumn('mentioned_id', 'integer')
            ->addColumn('created_at',   'datetime')
