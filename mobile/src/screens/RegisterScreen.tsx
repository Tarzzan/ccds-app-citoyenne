...
const styles = StyleSheet.create({
  ...
  separatorText: { marginHorizontal: 12, fontSize: 13, color: '#999', fontWeight: '600' },
  googleBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFF', borderWidth: 1.5, borderColor: '#DDD', borderRadius: 14, padding: 14, gap: 10 },
