-- ============================================================
-- Ma Commune — Base de données de test (ma_commune_test)
-- À exécuter avant de lancer la suite de tests d'intégration.
-- ============================================================

CREATE DATABASE IF NOT EXISTS ma_commune_test CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE ma_commune_test;
...
VALUES
(1, 'MC-20260226-TEST1', 3, 1, 'Nid-de-poule dangereux rue de la Paix', 48.8566, 2.3522, 'Rue de la Paix, Paris', 'submitted',   'high',   NOW()),
(2, 'MC-20260226-TEST2', 3, 2, 'Lampadaire éteint depuis 3 jours',      48.8570, 2.3530, 'Avenue de l\'Opéra',   'in_progress', 'medium', DATE_SUB(NOW(), INTERVAL 2 DAY)),
(3, 'MC-20260226-TEST3', 3, 3, 'Pelouse non tondue depuis 1 mois',      48.8580, 2.3510, 'Parc Monceau',         'resolved',    'low',    DATE_SUB(NOW(), INTERVAL 7 DAY));
